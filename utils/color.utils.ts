...
export const getSelectColor = (level: string, state: 'default' | 'focused' | 'dot'): string => {
  const colorMapping: { [key: string]: { default: string, focused: string, dot: string } } = {
    Unknown: {
      ...
      dot: 'flex items-center before:bg-gray-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    White: {
      default: 'text-black dark:text-gray-500',
      focused: 'bg-gray-100 text-gray-900 hover:bg-gray-200',
      dot: 'flex items-center before:bg-gray-100 before:border before:border-black before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Green: {
      ...
      dot: 'flex items-center before:bg-green-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Blue: {
      ...
      dot: 'flex items-center before:bg-blue-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Pink: {
      ...
      dot: 'flex items-center before:bg-pink-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Red: {
      default: 'text-red-400 hover:bg-red-600 hover:text-white',
      focused: 'bg-red-600 dark:bg-red-800 text-white hover:bg-red-600',
      dot: 'flex items-center before:bg-red-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Yellow: {
      ...
      dot: 'flex items-center before:bg-yellow-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Purple: {
      ...
      dot: 'flex items-center before:bg-purple-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Orange: {
      ...
      dot: 'flex items-center before:bg-orange-500 before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    },
    Black: {
      default: 'text-gray-500 hover:bg-gray-600',
      focused: 'bg-black text-white hover:bg-gray-600',
      dot: 'flex items-center before:bg-black before:border before:border-white before:rounded-full before:block before:mr-2 before:h-3 before:w-3 text-black dark:text-white'
    }
  };
