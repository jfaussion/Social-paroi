...
const UserRanking: React.FC<UserRankingProps> = ({ rank, profilePicture, name, score, isCurrentUser }) => {
  return (
    <div className={`relative flex items-center justify-between p-4 ${isCurrentUser ? 'bg-gray-300 dark:bg-gray-700' : ''}`}>
      <div className="flex items-center">
        <span className="text-lg font-bold w-5 sm:w-8 flex-shrink-0">{rank}</span>
      ...
      <span className="text-md font-bold">{score}</span>
      <div
