    ...
    <footer className="w-full border-t border-white/5 px-4 py-2">
      <div className="mx-auto flex max-w-2xl items-center justify-between gap-3">
        ...
        <nav className="flex flex-wrap items-center gap-3 text-sm text-white/60">
          <a href="https://github.com/jfaussion/Social-paroi" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 transition-colors hover:text-white">
            <FaGithub size={14} />
            GitHub
          </a>
          <a href={feedbackUrl} className="transition-colors hover:text-white">Feedback</a>
          <a href="#" className="transition-colors hover:text-white">Privacy</a>
          <span className="text-white/70">Made with ❤️ by Jérémie Faussion</span>
        </nav>
      </div>
    </footer>
  );
