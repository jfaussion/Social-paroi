export function ContestPlaceHolder() {
  return (
      ...
      <div className="flex items-center space-x-4">
        <div className="flex-1 space-y-6 py-1">
          ...
          <div className="space-y-3">
            ...
            <div className="h-3 bg-gray-400 w-[50%] dark:bg-gray-500 rounded"></div>
            <div className="h-3 bg-gray-400 w-[75%] dark:bg-gray-500 rounded"></div>
          </div>
        </div>
      </div>
    </div>
